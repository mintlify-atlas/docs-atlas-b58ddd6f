---
title: "Device Management in Smart Enviro Backend"
sidebarTitle: "Overview"
description: "Learn how devices are registered, discovered, claimed by users, and controlled through the Smart Enviro Backend API. Covers device lifecycle from provisioning to decommission."
---
...
Additional `log_type` values that can be written programmatically include `EVENT`, `INFO`, and `ERROR` for custom instrumentation.
