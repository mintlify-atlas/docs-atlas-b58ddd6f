...
description: "Device properties are key-value pairs stored per-device that configure thresholds, automation behavior, and hardware capabilities reported to the ESP32 on each sync."
---
