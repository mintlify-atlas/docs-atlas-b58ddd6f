...
description: "Complete schema reference for Smart Enviro Backend: users, devices, device_properties, sensor_types, sensor_data, and device_logs tables with relationships and index strategy."
---
