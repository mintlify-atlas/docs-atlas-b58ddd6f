---
title: "POST /api/sensor-data — Submit a Sensor Reading from ESP32"
sidebarTitle: "POST /sensor-data"
description: "POST /api/sensor-data — Authenticates via device_token, stores a sensor reading, updates device online status, and returns the device_control block with the current actuator command."
---
