---
title: "Delete Sensor Reading — DELETE /api/sensor-data/{id}"
sidebarTitle: "Delete Reading"
description: "Permanently removes a sensor reading by ID. No auth required. Returns 200 on success or 404 if the reading is not found in the database."
---
