...
sidebarTitle: "DELETE /api/logout"
description: "DELETE /api/logout — Revokes the current Sanctum bearer token and clears the single-session lock, allowing the user to log in from another device."
---
