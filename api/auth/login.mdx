...
sidebarTitle: "POST /api/login"
description: "POST /api/login — Validates email and password, creates a Sanctum personal access token, and enforces single-session policy. Returns user object and bearer token."
---
