---
title: "POST /api/register — Register a New User Account"
sidebarTitle: "User Register"
description: "Creates a new user with name, email, and confirmed password. Returns 201 Created on success; no token is issued — call POST /api/login to authenticate."
---
