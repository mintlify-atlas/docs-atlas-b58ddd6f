---
title: "Toggle Actuator State — POST /api/my-devices/{id}/toggle"
sidebarTitle: "Toggle State"
description: "POST /api/my-devices/{id}/toggle — Sets a device actuator to ON, OFF, or STANDBY. The ESP32 picks up the new command on its next sync call."
---
