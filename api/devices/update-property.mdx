---
title: "Update Device Property — PUT /api/my-devices/{id}"
sidebarTitle: "Update Property"
description: "PUT /api/my-devices/{id}/properties — Upserts a device config property by key. Both fields are required strings. Logs a COMMAND entry on every change."
---
