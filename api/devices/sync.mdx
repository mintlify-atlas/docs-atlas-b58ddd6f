---
title: "ESP32 Device Sync — Boot, Command, and Config Fetch"
sidebarTitle: "Device Sync"
description: "GET /api/device/sync — Public ESP32 endpoint. Sends device_token as a query param to get the current command and config. Returns SLEEP on invalid token."
---
