...
description: "Smart Enviro Backend is a Laravel 11 REST API that receives ESP32 sensor telemetry, delivers actuator commands, and exposes a device management surface for mobile clients."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Historical Data" icon="chart-line" href="api/sensor-data/store">
